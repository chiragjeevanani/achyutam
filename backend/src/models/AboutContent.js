...
const aboutContentSchema = new mongoose.Schema(
  {
    header: {
      ...
      title: { type: String, default: 'About Uppasna Keshwani' },
      description: { type: String, default: 'Meet the founder of Achyutam Maestro—a professional Vastu, Numerology, and Astrology consultant transforming lives across residences, commercial offices, and industrial hubs.' }
    },
    profile: {
      badge: { type: String, default: 'FOUNDER PROFILE' },
      title: { type: String, default: 'Uppasna Keshwani' },
