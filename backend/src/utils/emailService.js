...
const fromAddress = () =>
  `"Achyutam Maestro" <${process.env.SMTP_USER || 'noreply@achyutam.com'}>`;
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
        ...
        <p>Thank you for choosing <strong>Achyutam Maestro</strong>. Your appointment has been successfully booked. Please find your booking slip below.</p>
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
        ...
        <p>A new appointment has been booked on <strong>Achyutam Maestro</strong>. Details below:</p>
        ...
        <p style="color: #888; font-size: 13px;">This is an automated notification from the Achyutam Maestro booking system.</p>
      </div>
    `,
  };
